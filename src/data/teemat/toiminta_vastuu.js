const toiminta_vastuu = {
  ...
  slides: [
...

    {
      ...
      text:
        "Tuntemattomat tai poikkeavat viestit voivat olla huijausyrityksiä. Kiireellinen sävy, painostus, poikkeava linkki tai epätavallinen lähettäjä ovat tavallisia varoitusmerkkejä. Tärkeintä on olla klikkaamatta linkkejä tai avaamatta liitteitä ennen tarkistusta. Viesti kannattaa tarkistaa rauhallisesti, raportoida organisaation ohjeiden mukaan ja poistaa vasta ohjeistuksen mukaisesti. Näin yksittäinen epäilyttävä viesti ei pääse aiheuttamaan suurempaa vahinkoa."
    },
