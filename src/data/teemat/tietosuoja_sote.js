const tietosuoja_sote = {
 ...
 slides: [

  {
    ...
    text:
      "Tietosuoja tarkoittaa henkilötietojen suojaamista ja asianmukaista käsittelyä. Sosiaali- ja terveysalalla käsitellään erityisen arkaluonteisia tietoja, kuten terveystietoja ja sosiaalihuollon asiakastietoja. Tietosuoja ei ole vain lakisääteinen velvollisuus – se on osa luottamusta ja potilasturvallisuutta."
  },
...

  {
    ...
    text:
      "Vaikka organisaatiolla on johto, tietosuojavastaava ja IT-asiantuntijat, tietosuoja toteutuu arjessa jokaisen työntekijän toiminnassa. Huolellinen kirjautuminen, oikeiden vastaanottajien tarkistaminen ja ohjeiden noudattaminen ovat osa jokaisen ammatillista vastuuta."
  }
